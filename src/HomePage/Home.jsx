        ...
        <div>
            ...
            <section className="bg-gray-100 py-16 px-4 relative">
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-10">
                    ...
                    {/* Left Content */}
                    <div className="bg-[#e3e3e3] shadow-md p-10 max-w-xl w-full absolute left-40">
                        <h2 className="text-3xl font-semibold mb-4">
                            UniCamp Open Day
                        </h2>
                        <div className="w-16 h-1 bg-[#455A64] mb-6" />
                    ...
                    <div className="flex justify-end w-full">
                        <img
                            ...
                            alt="Campus"
                            className="w-3/5 h-full object-cover rounded-md"
                        />
                    </div>
                </div>
            </section>
